...
class LLMHandler:
    ...
    def create_prompt(
        ...
        """
        Create formatted prompt for Mistral Instruct
...
Based on the context above, provide a clear, step-by-step answer to help the user complete their task. [/INST]"""
    ...
    def generate_with_retrieval(
        ...
        """
        Complete RAG pipeline: generate response with retrieved context
